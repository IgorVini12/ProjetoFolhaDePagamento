...
public int cargaInicial(Funcionario[] lista) {
    /*arrumei essa tabela para fica mais coerente com os dados perdidos*/
    lista[0] = new Funcionario(1, "Ana Silva", "Analista", 3000, 2, 1, 8.50);  
    lista[1] = new Funcionario(2, "Bruno Souza", "Dev", 5000, 1, 0, 10.00);   
    lista[2] = new Funcionario(3, "Carlos Lima", "Suporte", 1800, 0, 2, 6.00); 
    lista[3] = new Funcionario(4, "Daniela Rocha", "Gerente", 8000, 0, 0, 12.00);
    lista[4] = new Funcionario(5, "Eduardo Alves", "Estagiário", 1200, 0, 0, 5.00);
    return 5;
}
